...
function getSearchResults() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://localhost:50347/Admin/GetVehicleSearchResults/' + searchTerm + '/' + minPrice + '/' + maxPrice +'/'+ minYear +'/' + maxYear,
    ...
    $.ajax({
        ...
        success: function (data, status) {
            $.each(data, function (index, vehicle) {
                ...
                var searchTerm = $('#search-term').val().toString();
                ...
                alert('price range 1 : ' + priceRange1 + 'pricerange2 is' + priceRange2);
                ...
                if (searchTerm == Model) {
                    ...
                    if (MRSP >= priceRange1 && MRSP <= PriceRange2) {
...
function appendVehicle() {
    ...
    $containerDiv.css('border-style', 'groove');
    $containerDiv.css('margin-top', '5px');
    $containerDiv.css('padding-top', '5px');
