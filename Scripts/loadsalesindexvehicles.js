...
function getSearchResults() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://localhost:50347/Sales/GetSalesIndexSearchResults/' + searchTerm + '/' + minPrice + '/' + maxPrice +'/'+ minYear +'/' + maxYear,
        ...
        success: function (data, status) {
            $.each(data, function (index, vehicle) {
                ...
                $("#" + trcolorvinbutton).append('<a href="/Sales/Purchase/' + VehicleId + '"><button class="btn btn-primary">Purchase</button></a>');
